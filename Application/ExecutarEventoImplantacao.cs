...
{
    public class ExecutarEventoImplantacao : IExecucaoEvento
    {
        private readonly ValidadorCobertura _validador;
        private readonly IEventosBase<EventoImplantacao> _eventos;
        ...
        {
            var evento = (EventoImplantacao)eventoOperacional;
